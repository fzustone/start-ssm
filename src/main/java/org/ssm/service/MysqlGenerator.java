...
/**
	...
	public static void main(String[] args) {
		...
		Props props = new Props("si-console.properties");
...
/*	// 自定义配置
		InjectionConfig cfg = new InjectionConfig() {
			...
			public void initMap() {
				...
				map.put("mapper", "com.cnc.si.mapper." + moduleName);
				map.put("model", "com.cnc.si.model." + moduleName);
				this.setMap(map);
			}
		};*//*
	...
	private static List<FileOutConfig> generateFileOutConfigs(String projectPath, PackageConfig pc) {
		...
		focList.add(new FileOutConfig("/template/CustomMapper.java.ftl") {
			...
			public String outputFile(TableInfo tableInfo) {
				// 自定义输入文件名称
				return projectPath + "/src/main/java/com/cnc/si/mapper/" + pc.getModuleName() + "/" +
		...
		focList.add(new FileOutConfig("/template/CustomEntity.java.ftl") {
			...
			public String outputFile(TableInfo tableInfo) {
				// 自定义输入文件名称
				return projectPath + "/src/main/java/com/cnc/si/model/" + pc.getModuleName() + "/" +
